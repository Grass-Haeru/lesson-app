...
def chat():
    try:
        ...
        chatgpt_responses = ask_multiple_students(conversation_history,num_students,target,view,grade,Taro_correct,Taro_wrong,Taro_idk,Hanako_correct,Hanako_wrong,Hanako_idk,Jiro_correct,Jiro_wrong,Jiro_idk,Misaki_correct,Misaki_wrong,Misaki_idk,subject,image_file)
...
def ask_chatgpt_as_student(conversation_history,num_students,target,view,grade,Taro_correct,Taro_wrong,Taro_idk,Hanako_correct,Hanako_wrong,Hanako_idk,Jiro_correct,Jiro_wrong,Jiro_idk,Misaki_correct,Misaki_wrong,Misaki_idk,subject,image_file):
    try:
        global tag
        ...
        if image_file: #画像ファイルが存在する場合
            ...
            response = client.chat.completions.create(
                ...
                messages=conversation_history+[
                    ...
                    {"role": "user", "content": [
                        {"type": "text", "text": "また子ども達は以下の画像をみて回答します。"},
...
# 複数の生徒に対して質問を送信する関数
def ask_multiple_students(conversation_history,num_students,target,view,grade,Taro_correct,Taro_wrong,Taro_idk,Hanako_correct,Hanako_wrong,Hanako_idk,Jiro_correct,Jiro_wrong,Jiro_idk,Misaki_correct,Misaki_wrong,Misaki_idk,subject,image_file):
    responses = []
    student_num = [1, 2, 3, 4]  # 生徒の名前をリストに設定 太郎:1, 花子:2, 次郎:3, 美咲:4
    response = ask_chatgpt_as_student(conversation_history,num_students,target,view,grade,Taro_correct,Taro_wrong,Taro_idk,Hanako_correct,Hanako_wrong,Hanako_idk,Jiro_correct,Jiro_wrong,Jiro_idk,Misaki_correct,Misaki_wrong,Misaki_idk,subject,image_file)
